...
class _ChatPageState extends State<ChatPage> {
  ...
  void getAnswer() async {
    const url = "https://generativelanguage.googleapis.com/v1beta2/models/chat-bison-001:generateMessage?key=AIzaSyAWcnm_RVY-S6IZf5pmYjyWMs7E60Unvro";
                  ...
                  child: Align(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        color: (_chatHistory[index]["isSender"] ? const Color(
                            0xFF03A9F4) : Colors.white), //Color for sender and recevier msgs
                      ),
